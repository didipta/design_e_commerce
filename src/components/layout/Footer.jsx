...
const Footer = () => {
  return (
    <footer className="bg-black text-text-light">
      <div className="container mx-auto grid lg:grid-cols-2 grid-cols-1 gap-8 py-12 px-6">
      ...
      <div className="bg-black border-t border-gray-800 py-8 px-6">
        <div className="container mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 md:px-12">
          <div>
